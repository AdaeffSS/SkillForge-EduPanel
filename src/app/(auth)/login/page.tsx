  ...
  return (
    <>
      ...
      <main className={st.main}>
        <div
          className={`${st.container} ${step === "confirm" ? st.confirm : ""}`}
        >
          <div
            className={`${st.content} ${step === "confirm" ? st.confirm : ""}`}
          >
            <form
              ref={formRef}
          ...
          <div
            className={`${st.confirm_block} ${step === "confirm" ? st.active : ""}`}
          >
            <Image
              className={st.logo}
              src="/images/logo-img.png"
            ...
            <form onSubmit={(e) => {
              ...
              <label>
                ...
                >
                  После нескольких неудачных попыток ввода доступ будет
                  заморожен на 2 часа
                </span>
              </label>
              <button
